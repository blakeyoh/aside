...
## 2026-05-05 - Feedback for background UI actions
**Learning:** Users lack confidence when silent background operations (like reloading a dictionary) complete without confirmation.
**Action:** Always provide ephemeral visual feedback (e.g., using status messages or toasts) for actions that complete silently to assure the user the action succeeded.
